...
/**
 * Class tool_fskandalis\event\record_created
 *
...
class record_created extends base {
    ...
    public static function get_name() {
        return get_string('eventrecordcreated', 'tool_fskandalis');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' created the record with id '$this->objectid'.";
    }
    ...
    public function get_url() {
        return new moodle_url('/admin/tool/fskandalis/index.php', array('id' => $this->courseid));
    }
