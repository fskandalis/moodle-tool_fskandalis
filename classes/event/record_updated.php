...
/**
 * Class tool_fskandalis\event\record_updated
 *
...
class record_updated extends base {
    ...
    public static function get_name() {
        return get_string('eventrecordupdated', 'tool_fskandalis');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the record with id '$this->objectid'.";
    }
